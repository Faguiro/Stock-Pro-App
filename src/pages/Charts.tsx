...
import {
    Box, Heading, Text, Spinner, Input, Stat, StatLabel, StatNumber,
     Table, Thead, Tr, Th, Td, Tbody, TableContainer, 
    Card, CardHeader,  SimpleGrid, Select, HStack, 
...
export default function MetricasPage() {
    ...
    const [dateRange, setDateRange] = useState<[Date, Date]>([new Date(new Date().setMonth(new Date().getMonth() - 1)), new Date()])
    ...
    const handleError = (err: any) => {
        const errorMessage = err.response?.data?.detail || 'Erro ao carregar métricas'
    ...
    if (loading) return (
        <Flex justify="center" align="center" minH="100vh">
            ...
            <Text mt={4} ml={4}>Carregando métricas...</Text>
        </Flex>
    )
        ...
        <Box p={8} maxW="1400px" mx="auto">
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4} mb={8}>
                <Card bg="blue.50" borderWidth="1px" borderColor="blue.100">
                    <CardHeader>
                        <Stat>
                            <StatLabel fontSize="sm" color="gray.600">Vendas Totais</StatLabel>
                            <StatNumber fontSize="2xl">
                                {metricas?.total_vendas.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                            </StatNumber>
                        </Stat>
                    </CardHeader>
                </Card>
                ...
                <Card bg="green.50" borderWidth="1px" borderColor="green.100">
                    <CardHeader>
                        <Stat>
                            <StatLabel fontSize="sm" color="gray.600">Lucro Total</StatLabel>
                            <StatNumber fontSize="2xl">
                                {metricas?.lucro_total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                            </StatNumber>
                        </Stat>
                    </CardHeader>
                </Card>
                ...
                <Card bg="purple.50" borderWidth="1px" borderColor="purple.100">
                    <CardHeader>
                        <Stat>
                            <StatLabel fontSize="sm" color="gray.600">Itens Vendidos</StatLabel>
                            <StatNumber fontSize="2xl">{metricas?.total_itens_vendidos}</StatNumber>
                        </Stat>
                    </CardHeader>
                </Card>
            </SimpleGrid>
            ...
            <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6} mb={8}>
                <Card p={4}>
                    <Heading size="md" mb={4}>Desempenho de Vendas</Heading>
                    <Box height="300px">
                ...
                <Card p={4}>
                    <Heading size="md" mb={4}>Top Produtos</Heading>
                    <TableContainer>
            ...
            <Card p={4}>
                <Heading size="md" mb={4}>Desempenho por Vendedor</Heading>
                <TableContainer>
                    <Table variant="simple" size="sm">
                        <Thead>
                            <Tr>
